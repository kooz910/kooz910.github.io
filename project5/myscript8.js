...
$(document).ready(function(){
 ...
 var value = temp;
    ...
    if(value < "-20")
        $("#a8").css("animation-duration","1s");

    else if(value < "-17.5")
        $("#a8").css("animation-duration","2s");
    
    else if(value < "-15")
        $("#a8").css("animation-duration","3s");
    
     else if(value < "-12.5")
         $("#a8").css("animation-duration","4s");

    else if(value < "-10")
         $("#a8").css("animation-duration","5s");
    
    else if(value < "-7.5")
       $("#a8").css("animation-duration","6s");
    
    else if(value < "-5")
       $("#a8").css("animation-duration","7s");
    
    else if(value < "-2.5")
        $("#a8").css("animation-duration","8s");
    
    else if(value < "0")
       $("#a8").css("animation-duration","9s");
    
    else if(value < "2.5")
        $("#a8").css("animation-duration","10s");

    else if(value < "5")
        $("#a8").css("animation-duration","11s");

    else if(value < "7.5")
         $("#a8").css("animation-duration","12s");

    else if(value < "12.5")
         $("#a8").css("animation-duration", "14s");
    else if(value < "15")
         $("#a8").css("animation-duration","15s");
    
    else if(value < "17.5")
         $("#a8").css("animation-duration","16s");

    else if(value < "20")
         $("#a8").css("animation-duration","17s");
    
    else if(value < "22.5")
         $("#a8").css("animation-duration","18s");
        
    else if(value < "25")
         $("#a8").css("animation-duration","19s");

     else if(value < "27.5")
         $("#a8").css("animation-duration","20s");
    
    else if(value < "30")
         $("#a8").css("animation-duration","21s");

    else if(value < "32.5")
         $("#a8").css("animation-duration","22s");

    else if(value < "35")
         $("#a8").css("animation-duration","23s");

    else if(value < "37.5")
         $("#a8").css("animation-duration","24s");

    else if (value < "40")
         $("#a8").css("animation-duration","25s");
