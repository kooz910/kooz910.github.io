...
function myWeatherInterpretation(){
   ...
   if(blobthick < "1")
    ...
    {svg2.setAttribute("stroke-width","10");svg2.setAttribute("stroke","#ffffcc");}
    
    else if(blobthick < "1.5")
    {svg2.setAttribute("stroke-width","20");svg2.setAttribute("stroke","#fff7c2");}
    
     else if(blobthick < "1.75")
    {svg2.setAttribute("stroke-width","30");svg2.setAttribute("stroke","#fff0b8");}

    else if(blobthick < "2")
    {svg2.setAttribute("stroke-width","40");svg2.setAttribute("stroke","#ffe8ad");}
    
    else if(blobthick < "2.25")
    {svg2.setAttribute("stroke-width","50");svg2.setAttribute("stroke","#ffe0a3");}
    
    else if(blobthick < "2.5")
    {svg2.setAttribute("stroke-width","60");svg2.setAttribute("stroke","#ffd999");}

    else if(blobthick < "2.75")
    {svg2.setAttribute("stroke-width","70");svg2.setAttribute("stroke","#ffd18f");}
    
    else if(blobthick < "3")
    {svg2.setAttribute("stroke-width","80");svg2.setAttribute("stroke","#ffc985");}
    
    else if(blobthick < "3.25")
   {svg2.setAttribute("stroke-width","90");svg2.setAttribute("stroke","#ffc27a");}

    else if(blobthick < "3.5")
    {svg2.setAttribute("stroke-width","100");svg2.setAttribute("stroke","#ffba70");}

    else if(blobthick < "3.75")
    {svg2.setAttribute("stroke-width","110");svg2.setAttribute("stroke","#ffb266");}
    
    else if(blobthick < "4")
    {svg2.setAttribute("stroke-width","120");svg2.setAttribute("stroke","#ffab5c");}

    else if(blobthick < "4.25")
    {svg2.setAttribute("stroke-width","130");svg2.setAttribute("stroke","#ffa352");}
    
    else if(blobthick < "4.5")
    {svg2.setAttribute("stroke-width","140");svg2.setAttribute("stroke","#ff9c47");}

    else if(blobthick < "4.75")
    {svg2.setAttribute("stroke-width","150");svg2.setAttribute("stroke","#ff943d");}

    else if(blobthick < "5")
    {svg2.setAttribute("stroke-width","160");svg2.setAttribute("stroke","#ff8c33");}
   
    else if(blobthick < "5.25")
   {svg2.setAttribute("stroke-width","170");svg2.setAttribute("stroke","#ff8529");}
    
    else if(blobthick < "5.5")
    {svg2.setAttribute("stroke-width","180");svg2.setAttribute("stroke","#ff7d1f");}

     else if(blobthick < "5.75")
    {svg2.setAttribute("stroke-width","190");svg2.setAttribute("stroke","#ff6e0a");}

    else if(blobthick < "6")
   {svg2.setAttribute("stroke-width","200");svg2.setAttribute("stroke","#ff6600");}
